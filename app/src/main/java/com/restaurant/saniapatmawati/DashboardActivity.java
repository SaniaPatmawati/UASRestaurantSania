package com.restaurant.saniapatmawati;
...
import com.restaurant.saniapatmawati.adapter.RestaurantAdapter;
import com.restaurant.saniapatmawati.data.Session;
import com.restaurant.saniapatmawati.model.ListRestaurantResponse;

import static com.restaurant.saniapatmawati.data.Constans.CREATE_RESTAURANT;
import static com.restaurant.saniapatmawati.data.Constans.DELETE_RESTAURANT;
import static com.restaurant.saniapatmawati.data.Constans.GET_LIST_RESTAURANT;
import static com.restaurant.saniapatmawati.data.Constans.GET_SEARCH_RESTAURANT;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.tambahResto:
                AndroidNetworking.post(CREATE_RESTAURANT)
                        ...
                        .addBodyParameter("namarm","Baso Beranak Sania")
                        .addBodyParameter("kategori","cafe")
                        .addBodyParameter("link_foto","https://ecs7.tokopedia.net/img/cache/700/product-1/2017/4/23/1100164/1100164_16449c9c-70fe-47a7-8974-943158356672.jpg")
